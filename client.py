...
# Mode 1: Data Dummy (HANYA UNTUK DEMO VISUAL BLOKIR, TANPA LABEL AKURASI)
...
# Mode 2: Data Acak Dinamis (HANYA UNTUK DEMO SPAM TERMINAL, TANPA LABEL AKURASI)
...
try:
    if pilihan == '3':
        ...
        for row in records:
            ...
            # Di mode 3 ini label aslinya akan terlihat karena memang dari CSV Asli
